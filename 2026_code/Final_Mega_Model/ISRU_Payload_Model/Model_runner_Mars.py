...
from Mars_Campaign.Define_Network_Vehicle_ISRU import (
    NetworkModel,
    reverse_tof,
...
from Mars_Campaign.Define_Commodities_Supply_Demand import (
    define_commodities,
    demand_supply,
    consumption_matrix
...
from Mars_Campaign.Define_Cost_Func import (
...
def build_model(network=None, vehicle_data=None, Demands=None, V_demands=None, isru_config=None,
    ...
    network = network or NetworkModel(campaign=True, yearloops=2)
