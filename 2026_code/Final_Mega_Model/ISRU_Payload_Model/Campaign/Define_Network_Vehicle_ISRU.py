...
def NetworkModel(campaign=False):
    ...
    Net.node_windows = {
        ...
        1: {
            ...
            1: [1, 12, 1+365, 12+365, 1+365*2, 12+365*2, 13+365*2],
            2: [1, 1+365, 1+365*2]
        },
        2: {
            1: [9, 9+365, 9+365*2],
            2: [4, 9, 4+365, 9+365, 4+365*2, 9+365*2, 13+365*2],
            3: [4, 4+365, 4+365*2]
        },
        3: {
            2: [8, 8+365, 8+365*2],
            3: [5, 8, 5+365, 8+365, 5+365*2, 8+365*2, 13+365*2]
        }
    }
...
def VehicleModel():
    ...
    Vehicle.payload_cap = np.array([4000, 2500])
    Vehicle.propellant_cap = np.array([200000, 30000])
